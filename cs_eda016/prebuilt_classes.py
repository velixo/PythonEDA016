...
class Square:
	...
	def draw(self, w : SimpleWindow):
		...
		w.move_to(x + round(r * math.cos(self.alpha + pi4)),
				  y + round(r * math.sin(self.alpha + pi4)))
		
		w.line_to(x + round(r * math.cos(self.alpha + 3 * pi4)),
				  y + round(r * math.sin(self.alpha + 3 * pi4)))
		
		w.line_to(x + round(r * math.cos(self.alpha + 5 * pi4)),
				  y + round(r * math.sin(self.alpha + 5 * pi4)))
		
		w.line_to(x + round(r * math.cos(self.alpha + 7 * pi4)),
				  y + round(r * math.sin(self.alpha + 7 * pi4)))
		
		w.line_to(x + round(r * math.cos(self.alpha + pi4)),
				  y + round(r * math.sin(self.alpha + pi4)))
